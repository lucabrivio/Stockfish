...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S(-16, 9), S(  1,-5), S(  7, 4), S( 3, 1) },
   { S(-23,-1), S( -7,-6), S( 19, 4), S(24, 5) },
   { S(-22, 3), S(-14, 3), S( 20,-1), S(35,-7) },
   { S(-11, 8), S(  0, 3), S(  3, 5), S(21,-2) },
   { S(-11, 5), S(-13,-1), S( -6, 4), S(-2, 1) },
   { S( -9, 1), S( 15,-8), S( -8, 2), S(-4,17) }
  },
  { // Knight
