...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Knight
   { S(-156,-106), S(-111, -92), S(-98,-56), S(-91,-24) },
   { S( -98, -79), S( -62, -66), S(-41,-29), S(-30, -3) },
   { S( -89, -60), S( -42, -51), S(-20,-20), S(-11, 16) },
   { S( -43, -51), S(  -2, -37), S( 23, -5), S( 27, 26) },
   { S( -44, -56), S(  -4, -37), S( 18,-10), S( 30, 29) },
   { S( -29, -65), S(  17, -50), S( 36,-14), S( 51, 15) },
   { S( -77, -74), S( -37, -62), S(-15,-36), S( -6,  1) },
   { S(-208,-119), S( -81,-100), S(-60,-60), S(-47,-23) }
  },
  { // Bishop
