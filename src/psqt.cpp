...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Knight
   { S(-145, -99), S(-100,-85), S(-87,-49), S(-80,-17) },
   { S( -87, -72), S( -51,-59), S(-30,-22), S(-19,  4) },
   { S( -78, -53), S( -31,-44), S( -9,-13), S(  0, 23) },
   { S( -32, -44), S(   9,-30), S( 34,  2), S( 38, 33) },
   { S( -33, -49), S(   7,-30), S( 29, -3), S( 41, 36) },
   { S( -18, -58), S(  28,-43), S( 47,-13), S( 62, 22) },
   { S( -66, -67), S( -26,-55), S( -4,-29), S(  5,  8) },
   { S(-197,-112), S( -70,-93), S(-49,-53), S(-36,-16) }
  },
  { // Bishop
