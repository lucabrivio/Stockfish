...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S(-16,10), S(  1, 0), S(  7, 1), S( 3, 9) },
   { S(-23, 5), S( -7,-3), S( 19, 1), S(24,-1) },
   { S(-22, 4), S(-14, 8), S( 20, 2), S(35,-1) },
   { S(-11, 5), S(  0,10), S(  3, 5), S(21, 3) },
   { S(-11, 7), S(-13, 1), S( -6, 7), S(-2, 6) },
   { S( -9,10), S( 15, 0), S( -8, 1), S(-4,12) }
  },
  { // Knight
